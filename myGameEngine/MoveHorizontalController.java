...
public class MoveHorizontalController extends AbstractInputAction
{
private Camera camera;
private MyGame mygame;
public MoveHorizontalController(Camera c,MyGame g)
{ camera = c;
mygame = g;
}
...
if (mygame.toggleDolphin!=true){
	...
	if (e.getValue()<0.0){
		mygame.dolphinN.moveRight(0.03f);
	} else {
		mygame.dolphinN.moveLeft(0.03f);
	}
