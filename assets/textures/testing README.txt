...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=testing&box=-117.532588,41.492949,-117.748461,41.331253
...
-----------
  ...
  * testing Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * testing Height Map (SRTM3 v4.1).png
  ...
  * testing Height Map (SRTM30 Plus).png
  ...
  * testing Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 1327m (actual) is equal to 40m in
